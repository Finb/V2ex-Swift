...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/CXSwipeGestureRecognizer/CXSwipeGestureRecognizer.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/INSImageView/INSImageView.framework"
